...
$(function () {
  ...
  $(window).scroll(function(){
    if($(this).scrollTop() >= 50){
      ...
      $('.navbar .nav-item .nav-link').css('color', '#aaa')
      $('.navbar .switch-lang .ar a').css('color', '#aaa')
    ...
    if($(this).scrollTop() <= 50){
      ...
      $('.navbar .nav-item .nav-link').css('color', '#eee')
      $('.navbar .switch-lang .ar a').css('color', '#eee')
